...
c deg of polarization 
      ...
      real mocyc
c state vector
      real r1(maxns,maxfr,3),r2(maxns,maxfr,3)
...
ccccccccccccccccccccccccccccc
     ...
     &   lfre,fre,lwlenf,llin,llim,lelm,lell,dopm,llh,rlll,lflog)
c
cccccccccccc
c READ DATA:
cccccccccccc
...
ccc     write(21,110)iyear,'.',par(1:ll+7),nsamp,dt
 110    format(i4,a1,A,1x,i5,1x,f10.7)
...
c-------------------------------
 ...
 10     nsmp2=nsmp/2
        ...
        if (.not.lflog) then
          ...
          nnfreq=nint(f2/df)-nint(f1/df)+1
          if (nfreq.gt.nnfreq) then
            nfreq=nint(nnfreq/1.)
            nfreq=abs(nfreq)
            write(*,*)'WARNING: change number of freqs to:',nfreq
          endif
          f1log=log10(f1)
          f2log=log10(f2)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccc
      if (dopm.lt.0.and..not.lflog) then
...
cccccccccccccccccccccccccc
 ...
 19     format(F8.3,1x,F14.10,1x,F8.5,1x,F14.5,1x,F6.4)
...
c
      ...
      logical llin,llim,lelm,lell,llh,lflog
      integer ntrac, nsamp, nfreq, nflen,wlen,wlenf
      real pow,f1,f2,dt,rycle,nocyc,mocyc,rlll
...
c defaults et al.: 
      ...
      if (lflog.and.lfre) then
         write(*,*)' WARNING: fre= does not yet work with flog !!'
         write(*,*)' WARNING: PG removes flog.'
         lflog=.false.
       endif
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      write(*,*)'             ave fre='
      write(*,*)' '
      write(*,*)'MOST USEFUL PARAMETERS:'
      write(*,*)'  f1,f2 :  Min & max frequency to be analysed.'
      write(*,*)'  nfr   :  # of frequency samples.'
      write(*,*)'           (pg alters nfr to adjust freq range.)' 
      write(*,*)'  flog  :  Sample freq band evenly on a log10 scale.'
      write(*,*)'           (Default is sampling linear space.)'
     ...
     & 'wlen=wlenf*f2/f '
      ...
      write(*,*)'           cycle controls the tf resolution.'
      write(*,*)'           cycle=2 or cycle=3 is fine for most '//
     & 'applications.'
      write(*,*)'           Try also greater values if freq resolution'
      write(*,*)'           is more important and/or you are looking at'
      write(*,*)'           presistent long-duration signals.'
      write(*,*)'  dopm= :  Output is further limited by ell. '//
     & 'dop > dopm'
      write(*,*)'           (dop=0.7 is default).' 
      write(*,*)'  pow=  :  Sensitivity of noise attenuation, i.e.,'//
     & ' to increase'
      write(*,*)'           difference between polarized and less '//
     & 'polarized'
      write(*,*)'           signals (default: pow=4).'
     ...
     & 'restrict'
      ...
      write(*,*)'OTHER PAREMETERS (usually not used or default):'
      ...
      write(*,*)'           to average (mean) spectrum (default: '//
     & 'nflen=1).'
     ...
     & 'not in a' 
      ...
      write(*,*)'  dopm  : 0.7'
      write(*,*)' '
      write(*,*)'RECOMMENDATIONS: Perform small test-data runs to '
      write(*,*)'adjust the program parameters and to avoid billions'
      write(*,*)'of signals in the output. Use dopm= and pow= to' 
      write(*,*)'control the output size (and sensitivity).' 
      write(*,*)'I.e., reduce the numb. of signals on output increasing'
      write(*,*)'dopm= and/or pow=. Increasing wlenf= will also '//
     & 'decrease'
      write(*,*)'the numb. of stably polarized signals since it becomes'
      write(*,*)'more difficult to find stably polarized features over'
      write(*,*)'longer time windows. Also note that a great nfr= '
      write(*,*)'increases the computation time and output. Using '
      write(*,*)'flog (evenly spaced sampling of freqs on a log10 '//
     & 'scale)'
      write(*,*)'may permit to decrease the nfr= .'
      write(*,*)
      write(*,*)'Most important parameters to set are:'
      write(*,*)'  f1= f2= dopm= wlenf= nfr= pow= cycle='
      write(*,*)'Other useful parameters:' 
      write(*,*)'  flog ell='
      write(*,*)
     ...
     & ' improvements, collaborations,'
      ...
      write(*,*)' '
      write(*,*)'LAST MODIFICATION: 29.07.2019 '
      write(*,*)' '
